...
const tagCols2=db.prepare(`PRAGMA table_info(nfc_tags)`).all().map(c=>c.name); if(!tagCols2.includes("reward_text")) db.exec(`ALTER TABLE nfc_tags ADD COLUMN reward_text TEXT`);
